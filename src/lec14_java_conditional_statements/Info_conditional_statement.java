...
-- The nested if statement represents the if block within another if or else block. Here, the inner if block condition executes only when the outer if block condition is true.
