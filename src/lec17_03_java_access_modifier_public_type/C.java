...
import lec17_04_java_access_modifier_class_from_outside_package.M;
...
public class C extends M {
	...
	public static void main(String[] args) {
		...
		System.out.println("---------- The below is coming from class M of package 'lec17_04_java_access_modifier_class_from_outside_package' ----------\n");
		C c = new C();
		c.m1();
